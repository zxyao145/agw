    ...
    public partial class EnforceUserDataIsolation : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(
                "UPDATE agentflow SET create_by = '1001' WHERE create_by IS NULL OR trim(create_by) = '';"
            );
            migrationBuilder.Sql(
                "UPDATE api_token SET create_by = '1001' WHERE create_by IS NULL OR trim(create_by) = '';"
            );
            migrationBuilder.Sql(
                "UPDATE integration_connection SET create_by = '1001' WHERE create_by IS NULL OR trim(create_by) = '';"
            );
            migrationBuilder.Sql("UPDATE job SET create_by = '1001' WHERE create_by IS NULL OR trim(create_by) = '';");
            migrationBuilder.Sql(
                "UPDATE mcp_server SET create_by = '1001' WHERE create_by IS NULL OR trim(create_by) = '';"
            );
            migrationBuilder.Sql(
                "UPDATE model SET create_by = '1001' WHERE create_by IS NULL OR trim(create_by) = '';"
            );
            migrationBuilder.Sql(
                "UPDATE plugin_installation SET create_by = '1001' WHERE create_by IS NULL OR trim(create_by) = '';"
            );
            migrationBuilder.Sql(
                "UPDATE project SET create_by = '1001' WHERE create_by IS NULL OR trim(create_by) = '';"
            );
            migrationBuilder.Sql(
                "UPDATE provider SET create_by = '1001' WHERE create_by IS NULL OR trim(create_by) = '';"
            );
            migrationBuilder.Sql(
                "UPDATE skill SET create_by = '1001' WHERE create_by IS NULL OR trim(create_by) = '';"
            );
            migrationBuilder.Sql(
                "UPDATE project_conversation SET create_by = '1001' WHERE create_by IS NULL OR trim(create_by) = '';"
            );
            migrationBuilder.Sql(
                "UPDATE model_provider_relation SET create_by = '1001' WHERE create_by IS NULL OR trim(create_by) = '';"
            );
            migrationBuilder.Sql(
                "UPDATE agent SET create_by = '1001' WHERE create_by IS NULL OR trim(create_by) = '';"
            );
            migrationBuilder.Sql(
                "UPDATE durable_execution SET user_id = '1001' WHERE user_id IS NULL OR trim(user_id) = '';"
            );
            migrationBuilder.Sql(
                "UPDATE agentflow_checkpoint SET user_id = '1001' WHERE user_id IS NULL OR trim(user_id) = '';"
            );
            migrationBuilder.Sql(
                "UPDATE user_memory SET user_id = '1001' WHERE user_id IS NULL OR trim(user_id) = '';"
            );
            ...
            migrationBuilder.Sql(
                "UPDATE agent_usage SET user_id = (SELECT create_by FROM project WHERE project.id = agent_usage.project_id) "
                    ...
                    + "AND EXISTS (SELECT 1 FROM project WHERE project.id = agent_usage.project_id AND trim(create_by) <> '');"
            );
            migrationBuilder.Sql(
                "UPDATE agent_usage SET user_id = '1001' WHERE user_id IS NULL OR trim(user_id) = '';"
            );
