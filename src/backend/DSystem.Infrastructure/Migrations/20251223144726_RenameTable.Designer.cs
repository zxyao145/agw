...
namespace DSystem.Infrastructure.Migrations
{
    ...
    [Migration("20251223144726_RenameTable")]
            ...
            modelBuilder.Entity("DSystem.Domain.Entities.ModelProviderApiKey", b =>
                {
                    ...
                    b.HasIndex("ModelId", "ProviderId")
                        .HasDatabaseName("ix_model_provider_api_keys_model_id_provider_id");
            ...
            modelBuilder.Entity("DSystem.Domain.Entities.AgentflowEdge", b =>
                {
                    b.HasOne("DSystem.Domain.Entities.Agentflow", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_agentflow_edges_agentflows_agentflow_id");
            ...
            modelBuilder.Entity("DSystem.Domain.Entities.AgentflowNode", b =>
                {
                    ...
                    b.HasOne("DSystem.Domain.Entities.Agentflow", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_agentflow_nodes_agentflows_agentflow_id");
                });
            ...
            modelBuilder.Entity("DSystem.Domain.Entities.ModelProviderApiKey", b =>
                {
                    b.HasOne("DSystem.Domain.Entities.ModelProvider", "ModelProvider")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_model_provider_api_keys_model_providers_model_id_provider_id");
