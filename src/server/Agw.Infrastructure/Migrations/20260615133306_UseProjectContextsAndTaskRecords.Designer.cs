...
namespace Agw.Infrastructure.Migrations
{
    ...
    [Migration("20260615133306_UseProjectContextsAndTaskRecords")]
    partial class UseProjectContextsAndTaskRecords
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Agw.Shared.Data.Entities.Projects.TaskSessionBinding", b =>
                {
                    ...
                    b.HasIndex("TaskId", "AgentId", "ExternalAgentName")
                        .IsUnique()
                        .HasDatabaseName("ix_task_session_binding_task_id_agent_id_external_agent_name");
