...
namespace Agw.Infrastructure.Migrations
{
    ...
    [Migration("20260504095643_AddSessionBind")]
    partial class AddSessionBind
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Agw.Agents.Domain.Entities.Agent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("Agw.Agents.Domain.Entities.AgentAppRelation", b =>
                {
            ...
            modelBuilder.Entity("Agw.Agents.Domain.Entities.AgentMcpServerRelation", b =>
                {
                    b.Property<Guid>("AgentId")
                        .HasColumnType("TEXT")
                        .HasColumnName("agent_id");
            ...
            modelBuilder.Entity("Agw.Agents.Domain.Entities.AgentSkillRelation", b =>
                {
                    b.Property<Guid>("AgentId")
                        .HasColumnType("TEXT")
                        .HasColumnName("agent_id");
            ...
            modelBuilder.Entity("Agw.Agents.Domain.Entities.Agentflow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("Agw.Agents.Domain.Entities.AgentflowEdge", b =>
                {
            ...
            modelBuilder.Entity("Agw.Agents.Domain.Entities.AgentflowNode", b =>
                {
                    b.Property<Guid>("AgentflowId")
                        .HasColumnType("TEXT")
                        .HasColumnName("agentflow_id");
                    ...
                    b.HasIndex("AgentId")
                        .HasDatabaseName("ix_agentflow_node_agent_id");

                    b.HasIndex("AgentflowId", "Type", "RelateId")
                        .IsUnique()
                        .HasDatabaseName("ix_agentflow_node_agentflow_id_type_relate_id");

                    b.ToTable("agentflow_node", (string)null);
                });

            modelBuilder.Entity("Agw.Agents.Domain.Entities.McpServer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("Agw.Integrations.Domain.Entities.AppInstance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("Agw.Integrations.Domain.Entities.OAuthAuthorizationToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("Agw.Providers.Domain.Entities.LlmModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("Agw.Providers.Domain.Entities.ModelProviderRelation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("Agw.Providers.Domain.Entities.Provider", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("Agw.Providers.Domain.Entities.ProviderAuthConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("Agw.Shared.Data.Entities.Projects.ProjectTask", b =>
                {
                    ...
                    b.HasIndex("ContextId")
                        .IsUnique()
                        .HasDatabaseName("ix_project_task_context_id");

                    b.HasIndex("ProjectId")
                        .HasDatabaseName("ix_project_task_project_id");

                    b.HasIndex("ProjectId", "Status", "UpdateTime")
                        .HasDatabaseName("ix_project_task_project_id_status_update_time");

                    b.ToTable("project_task", (string)null);
                });

            modelBuilder.Entity("Agw.Shared.Data.Entities.Projects.ProjectTaskSessionBinding", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_project_task_session_binding");

                    b.HasIndex("ExternalAgentName", "ProviderSessionId")
                        .HasDatabaseName("ix_project_task_session_binding_external_agent_name_provider_session_id");

                    b.HasIndex("TaskId", "AgentId", "ExternalAgentName")
                        .IsUnique()
                        .HasDatabaseName("ix_project_task_session_binding_task_id_agent_id_external_agent_name");

                    b.ToTable("project_task_session_binding", (string)null);
                });
            ...
            modelBuilder.Entity("Agw.Agents.Domain.Entities.Agent", b =>
                {
                    b.HasOne("Agw.Providers.Domain.Entities.ModelProviderRelation", "ModelProvider")
                        .WithMany()
            ...
            modelBuilder.Entity("Agw.Agents.Domain.Entities.AgentAppRelation", b =>
                {
                    b.HasOne("Agw.Agents.Domain.Entities.Agent", "Agent")
                    ...
                    b.HasOne("Agw.Integrations.Domain.Entities.AppInstance", "AppInstance")
                        .WithMany()
            ...
            modelBuilder.Entity("Agw.Agents.Domain.Entities.AgentMcpServerRelation", b =>
                {
                    ...
                    b.HasOne("Agw.Agents.Domain.Entities.McpServer", "McpToolServer")
                        .WithMany("AgentMcpToolServers")
            ...
            modelBuilder.Entity("Agw.Agents.Domain.Entities.AgentflowEdge", b =>
                {
                    b.HasOne("Agw.Agents.Domain.Entities.Agentflow", null)
                        .WithMany("Edges")
                    ...
                    b.HasOne("Agw.Agents.Domain.Entities.AgentflowNode", "SourceNode")
                    ...
                    b.HasOne("Agw.Agents.Domain.Entities.AgentflowNode", "TargetNode")
            ...
            modelBuilder.Entity("Agw.Agents.Domain.Entities.AgentflowNode", b =>
                {
                    b.HasOne("Agw.Agents.Domain.Entities.Agent", null)
                        .WithMany("Agentflows")
                        .HasForeignKey("AgentId")
                        .HasConstraintName("fk_agentflow_node_agent_agent_id");
            ...
            modelBuilder.Entity("Agw.Integrations.Domain.Entities.OAuthAuthorizationToken", b =>
                {
                    b.HasOne("Agw.Integrations.Domain.Entities.AppInstance", null)
                        .WithOne("AuthorizationToken")
                        .HasForeignKey("Agw.Integrations.Domain.Entities.OAuthAuthorizationToken", "AppInstanceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Agw.Providers.Domain.Entities.ModelProviderRelation", b =>
                {
                    b.HasOne("Agw.Providers.Domain.Entities.LlmModel", "Model")
                        .WithMany("Providers")
                    ...
                    b.HasOne("Agw.Providers.Domain.Entities.Provider", "Provider")
                        .WithMany("Models")
            ...
            modelBuilder.Entity("Agw.Shared.Data.Entities.Projects.ProjectTaskSessionBinding", b =>
                {
                    b.HasOne("Agw.Shared.Data.Entities.Projects.ProjectTask", "Task")
                        .WithMany()
                        .HasForeignKey("TaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_project_task_session_binding_project_task_task_id");
