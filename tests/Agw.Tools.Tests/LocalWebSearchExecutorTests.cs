...
public class LocalWebSearchExecutorTests
{
    [Fact]
    public async Task InvokeAsync_WhenBingFails_UsesGoogleResults()
    {
        ...
        Assert.Equal(["www.bing.com", "www.google.com"], requestedHosts);
    }

    [Fact]
    public async Task InvokeAsync_WhenBingSucceeds_UsesBingResults()
    {
        var requestedHosts = new List<string>();
        var tool = CreateWebSearchFunction(request =>
        {
        ...
        Assert.Equal(["www.bing.com"], requestedHosts);
    }
    ...
    public async Task InvokeAsync_WhenAllSearchProvidersFail_ThrowsAgwException()
    {
        ...
        Assert.Equal(["www.bing.com", "www.google.com", "www.baidu.com"], requestedHosts);
    }
