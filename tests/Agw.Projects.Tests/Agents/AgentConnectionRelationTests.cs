...
public class AgentConnectionRelationTests
{
    ...
    public async Task CreateAgentAsync_WhenConnectionIdsContainDuplicates_PersistsDistinctExistingConnections()
    {
        ...
        var relation = Assert.Single(await assertContext.AgentConnectionRelations
            .Where(relation => relation.AgentId == agent.Id)
    ...
    private sealed class TestScope : IAsyncDisposable
    {
        ...
        private static AgentAppService CreateService(AgwDbContext dbContext) => new(
