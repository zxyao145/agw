...
- [AGW features]({{< relref "/docs/features" >}}): explore custom agents, Agentflow, agent handoffs, image input, memory, working modes, structured responses, tool approval, file and Git change review, multiple clients, and third-party sign-in.
