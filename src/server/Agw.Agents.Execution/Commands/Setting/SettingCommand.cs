...
public class SettingCommand : AgentRunCommand, IEquatable<SettingCommand>
{
    ...
    /// <summary>
    /// 连接所属的 Project Conversation；客户端生成，对话在首次受理时才保存。
    /// The Project Conversation this connection belongs to; generated by the client and saved at the first acceptance.
    /// </summary>
