...
namespace Agw.Infrastructure.Migrations
{
    ...
    [Migration("20260729142455_ReplaceBuildingBlocksWithTypedTools")]
    partial class ReplaceBuildingBlocksWithTypedTools
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Agw.Shared.Data.Entities.Agents.AgentFileMemoryEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_agent_file_memory");

                    b.HasIndex("UpdatedAt")
                        .HasDatabaseName("ix_agent_file_memory_updated_at");

                    b.HasIndex("ProjectId", "ConversationId", "AgentId", "Path")
                        .IsUnique()
                        .HasDatabaseName("ix_agent_file_memory_project_id_conversation_id_agent_id_path");

                    b.ToTable("agent_file_memory", (string)null);
                });
