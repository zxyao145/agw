...
`Agw.slnx` includes these backend projects plus the A2A, Agents, Files, Setup, Shared, Skills, Tasks, and Tools test projects. `Agw.Jobs.Tests` is run separately.
