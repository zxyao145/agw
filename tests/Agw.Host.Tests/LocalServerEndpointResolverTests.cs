...
public class LocalServerEndpointResolverTests
{
    ...
    {
        var result = LocalServerEndpointResolver.ResolveDefaultUrl(30816, port => port == 30816, () => 49152);
    ...
    {
        var result = LocalServerEndpointResolver.ResolveDefaultUrl(30816, _ => false, () => 49152);
