...
public class TemporalTypePolicyTests
{
    ...
    public void PersistedAndContractTimestamps_UseDateTimeOffset()
    {
        ...
        AssertPropertyType<ProjectConversationChatHistory>(
            nameof(ProjectConversationChatHistory.CreateTime),
            typeof(DateTimeOffset)
        );
        AssertPropertyType<ProjectConversationChatHistory>(
            nameof(ProjectConversationChatHistory.UpdateTime),
            typeof(DateTimeOffset?)
        );
        AssertPropertyType<ProjectConversationChatHistory>(
            nameof(ProjectConversationChatHistory.FinishedTime),
            typeof(DateTimeOffset?)
        );
