...
type ProjectTaskCreateRequest = components["schemas"]["ProjectTaskCreateRequest"]
...
export default function ProjectDetailsPage() {
  ...
  const reorderTaskMutation = useMutation({
    mutationFn: async (taskId: string) => {
      const body: ProjectTaskReorderRequest = { updateTimeUtc: new Date().toISOString() }
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div className="min-w-0 space-y-1">
          <div className="flex flex-wrap items-center gap-2">
            ...
            {project ? (
              <span className={`rounded-md px-2 py-0.5 text-xs ${statusClassName(project.enable ? 2 : 0)}`}>
            ...
            <Dialog open={createTaskOpen} onOpenChange={setCreateTaskOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <UiDialogDescription>
                    Create a task under this project. Tasks execute asynchronously (scheduler will pick it up).
                  </UiDialogDescription>
                </DialogHeader>
                ...
                {workflowsQuery.isLoading ? (
                  ...
                  <div className="text-sm text-destructive">
                    Failed to load workflows: {getApiErrorMessage(workflowsQuery.error)}
                  </div>
                ) : (
                  <div className="grid gap-4">
                    <div className="grid gap-2">
                      ...
                      <select
                        ...
                        onChange={(e) => setCreateTaskWorkflowId(e.target.value)}
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                      <div className="min-w-0 space-y-1">
                        ...
                        <div className="text-xs text-muted-foreground">
                          ...
                          <span className="mx-2">·</span>
                          Workflow: <span className="font-mono">{t.workflowId}</span>
                        </div>
                      ...
                      <div className="flex flex-wrap gap-2 sm:justify-end">
                        ...
                        <Button
                          ...
                          title={isPending ? "Reorder (bump updateTimeUtc)" : "Only pending tasks can be reordered"}
                        >
            ...
            <Button
              ...
              onClick={() => {
                ...
                updateTaskMutation.mutate({
                  taskId: editTaskId,
                  body: { description: editTaskDescription, input: editTaskInput },
                })
              }}
              disabled={
                !editTaskId ||
