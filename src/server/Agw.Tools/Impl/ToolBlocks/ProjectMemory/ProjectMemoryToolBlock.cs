...
public sealed class ProjectMemoryToolBlock : IToolBlock
{
    ...
    public ToolBlockDescriptor Descriptor { get; } =
        new(
            ...
            [
                new(ProjectMemoryProvider.WriteToolName, AgwToolPermission.Write),
                new(ProjectMemoryProvider.ReadFileToolName, AgwToolPermission.ReadOnly, allowInPlanMode: true),
                new(ProjectMemoryProvider.DeleteFileToolName, AgwToolPermission.Write),
                new(ProjectMemoryProvider.LsToolName, AgwToolPermission.ReadOnly, allowInPlanMode: true),
                new(ProjectMemoryProvider.GrepToolName, AgwToolPermission.ReadOnly, allowInPlanMode: true),
                new(ProjectMemoryProvider.ReplaceToolName, AgwToolPermission.Write),
                new(ProjectMemoryProvider.ReplaceLinesToolName, AgwToolPermission.Write),
            ]
        );
