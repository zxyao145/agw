...
public static class ToolValueObjectJson
{
    ...
    public static bool SequenceEqual(IReadOnlyList<ToolValueObject>? left, IReadOnlyList<ToolValueObject>? right) =>
        ReferenceEquals(left, right)
        || left != null && right != null && string.Equals(Serialize(left), Serialize(right), StringComparison.Ordinal);
